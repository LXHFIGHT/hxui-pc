...
let LoginCtrl = angular.module('CommonController');

LoginCtrl.controller('LoginCtrl', ['$scope', '$state', '$stateParams', 'HttpHelper', 'StorageHelper', 'config',
    ($scope, $state, $stateParams, HttpHelper, StorageHelper, config) => {
