...
(function ($, window) {
    window.HXUI = window.HXUI || {};
    var confirmModalQuery = '.hx-modal.confirm';
    /**
     * 展示加载框
     * @param options
    ...
    var confirm = function confirm(options) {
        ...
        var _quitConfirm = function _quitConfirm() {
            ...
            window.HXUI.showConfirmTimer2 = setTimeout(function () {
        ...
        if ($view.length !== 0) {
            $view.remove();
            var _window$HXUI2 = window.HXUI,
                shopTipTimer = _window$HXUI2.shopTipTimer,
                shopTipTimer2 = _window$HXUI2.shopTipTimer2;
    ...
    window.HXUI = Object.assign(window.HXUI, { confirm: confirm });
})(jQuery, window);
'use strict';
...
(function ($, window) {
    ...
    var toast = function toast(options) {
        ...
        if ($view.length !== 0) {
            $view.remove();
            var _window$HXUI = window.HXUI,
                shopTipTimer = _window$HXUI.shopTipTimer,
                shopTipTimer2 = _window$HXUI.shopTipTimer2;
        ...
        $(node).appendTo('body');
        window.HXUI.shopTipTimer = setTimeout(function () {
            $(tipsModalQuery).addClass('show');
        }, 10);
        window.HXUI.shopTipTimer2 = setTimeout(function () {
            $(tipsModalQuery).removeClass('show');
        }, during);
    };

    window.HXUI = Object.assign(window.HXUI, { toast: toast });
})(jQuery, window);
'use strict';
